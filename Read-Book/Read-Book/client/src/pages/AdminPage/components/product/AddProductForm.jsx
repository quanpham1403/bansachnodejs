...
const AddProductForm = (props) => {
    ...
    const { clickClose, categories, onAddBookSuccess, genres } = props;
    ...
    return (
        <>
            ...
            <div className="w-[500px] bg-[#fff] box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; px-5 py-2 rounded-md">
                ...
                {/* tác giả */}
                <input onChange={(e) => setAuthor(e.target.value)} type="text" name="author" placeholder="Nhập tác giả" className="w-full p-2 rounded-md border mb-3" />
                {/* nhà xuất bản */}
