...
const EditProductForm = (props) => {
    ...
    useEffect(() => {
        if (book) {
            ...
            setLabelBook(book.labelBook || "");
            setImgBook(book.imgBook || "");
            setPriceBook(book.price || "");
            setPublishingCompany(book.publishingCompany || "");
            setCategories(book.genres[0].name|| "");
            setDescriptionBook(book.descriptionBook || "");
            setCategoryProduct(book.categoryProduct || "");
    ...
    const handleUpdateBook = async (categoryId) => {
        try {
          ...
          await UpdateBook(categoryId, data);   
        //   const updatedCategoryList = await GetDataBook();
